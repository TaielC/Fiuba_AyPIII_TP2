...
public class TableroHachaPiedraTemplate extends TableroConstruccionHerramienta {

    public TableroHachaPiedraTemplate(){
        super();

        tablero[0] = new PiedraMaterialHerramienta();
