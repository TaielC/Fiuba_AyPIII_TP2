...
public class TableroHachaMaderaEspejadoTemplate extends TableroConstruccionHerramienta {

    public TableroHachaMaderaEspejadoTemplate(){
        super();

        tablero[1] = new MaderaMaterialHerramienta();
        tablero[2] = new MaderaMaterialHerramienta();
        tablero[4] = new MaderaMaterialHerramienta();
        tablero[5] = new MaderaMaterialHerramienta();
