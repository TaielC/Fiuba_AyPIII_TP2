...
public class TableroHachaMetalEspejadoTemplate extends TableroConstruccionHerramienta {

    public TableroHachaMetalEspejadoTemplate(){
        super();

        tablero[1] = new MetalMaterialHerramienta();
        tablero[2] = new MetalMaterialHerramienta();
        tablero[4] = new MaderaMaterialHerramienta();
        tablero[5] = new MetalMaterialHerramienta();
