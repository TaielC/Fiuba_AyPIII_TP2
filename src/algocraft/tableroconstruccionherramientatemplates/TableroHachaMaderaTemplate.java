...
public class TableroHachaMaderaTemplate extends TableroConstruccionHerramienta {

    public TableroHachaMaderaTemplate(){
        super();

        tablero[0] = new MaderaMaterialHerramienta();
        tablero[1] = new MaderaMaterialHerramienta();
        tablero[3] = new MaderaMaterialHerramienta();
